...
// Get the Numbers from the user
	ldr	x0,	=szA	// Load szA to be stored
	mov	x1,	#21	// # of bytes szA is storing
	bl	getstring	// Get user input
	ldr	x0,	=szB	// Load szB to be stored
	bl	getstring	// Get user input
	ldr	x0,	=szC	// Load szC to be stored
	bl	getstring	// Get user input
	ldr	x0,	=szD	// Load szD to be stored
	bl	getstring	// Get user input
...
// Add the values and store to dbR
	sub	x0,	x0,	x1	// Add dbA and dbB
	add	x0,	x0,	x2	// Add dbC to sum
	sub	x0,	x0,	x3	// Add dbD to sum
